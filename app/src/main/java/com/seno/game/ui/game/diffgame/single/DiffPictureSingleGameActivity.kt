...
class DiffPictureSingleGameActivity : BaseActivity<ActivityDiffPictureSingleGameBinding>(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            activity = this@DiffPictureSingleGameActivity
            ...
            repeatOnLifecycle(Lifecycle.State.STARTED) {
                ...
                launch {
                    viewModel.drawRightAnswerMark.collect { point ->
                        ...
                        (this@DiffPictureSingleGameActivity).drawLottieAnswerCircle(
                ...
                launch {
                    viewModel.drawWrongAnswerMark.collect {
                        ...
                        lottieAnimationView = (this@DiffPictureSingleGameActivity).drawLottieAnswerCircle(
                            x = it.first,
                            y = it.second,
                ...
                launch {
                    viewModel.drawAnswerHint.collect { point ->
                        ...
                        lottieAnimationView1 = (this@DiffPictureSingleGameActivity).drawLottieAnswerCircle(
                            x = binding.ivOrigin.x + answerCenterX - (point.answerRadius / 2),
                            y = binding.ivOrigin.y + answerCenterY - (point.answerRadius / 2),
                            rawRes = R.raw.right_answer_mark,
                            speed = 2f,
                        ...
                        lottieAnimationView2 = (this@DiffPictureSingleGameActivity).drawLottieAnswerCircle(
                            x = binding.ivCopy.x + answerCenterX - (point.answerRadius / 2),
                            y = binding.ivCopy.y + answerCenterY - (point.answerRadius / 2),
                            rawRes = R.raw.right_answer_mark,
                            speed = 2f,
...
//        }
        ...
        // 리워드 광고 로드
        RewardedAd.load(
            this@DiffPictureSingleGameActivity,
            ...
            object : RewardedAdLoadCallback() {
                ...
                override fun onAdLoaded(rewardedAd: RewardedAd) {
                    ...
                    this@DiffPictureSingleGameActivity.rewardedAd = rewardedAd
                    this@DiffPictureSingleGameActivity.rewardedAd?.fullScreenContentCallback = fullScreenContentCallback
                    this@DiffPictureSingleGameActivity.rewardedAd?.show(this@DiffPictureSingleGameActivity) { rewardItem ->
                        isShowHint = true
                        isLoadingVideoAD = false
                    }
                }
