...
@AndroidEntryPoint
class DPMultiPlayActivity : BaseActivity<ActivityDiffPictureMultiGameBinding>(
    layoutResId = R.layout.activity_diff_picture_multi_game,
    isLightStatusBar = true,
    isLightNavigationBar = false
) {
    private val viewModel by viewModels<DPMultiPlayViewModel>()
    private val admobRewardedAdUtil: AdmobRewardedAdUtil by lazy { AdmobRewardedAdUtil(this@DPMultiPlayActivity) }
    ...
    private fun initSetting() {
        binding.apply {
            activity = this@DPMultiPlayActivity
    ...
    private fun setDiffPictureResource(bitmap1: Bitmap, bitmap2: Bitmap) {
        Glide.with(this@DPMultiPlayActivity)
            .load(bitmap1)
